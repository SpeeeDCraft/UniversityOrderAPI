...
public class CategoryController : BaseApiController
{
    ...
    public async Task<CreateCategoryResponse> CreateCategory([FromBody] CreateCategoryRequest request)
    {
        ...
        var response = await  commandHandler
            .Handle(new CreateCategoryCommand(GetStudentStoreId, request.Name), new CancellationToken());
    ...
    public async Task<EditCategoryResponse> EditCategory([FromBody] EditCategoryRequest request)
    {
        ...
        var response = await  commandHandler.Handle(new EditCategoryCommand(new CategoryDTO
        {
            Id = request.Item.Id,
    ...
    public Task DeleteCategory(int id)
    {
        ...
        return commandHandler.Handle(new DeleteCategoryCommand(id), new CancellationToken());
    }
